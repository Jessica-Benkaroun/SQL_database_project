...
The next step is to build the database using SQL queries to create tables and insert data into them. Run the SQL script provided [here](Database_projects/payroll_database.sql) in MySQL Workbench. 
